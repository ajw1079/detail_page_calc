$(document).ready(function(){
    ...
    $(document).on("click", ".item_del", function(){
        ...
        $each_total_price.splice($del_index, 1);  //해당하는 인덱스번호의 데이터를 삭제하고 나머지는 저장
    ...
    //조건  1번 셀렉트 박스가 선택이 된 상태 후, 2번 셀렉트 박스가 선택이 되었을 때 change 이벤트를 걸어 각 세부항목인 .my_item을 ul아래의 마지막 자식에 추가
    ...
    $(".form_gram select").change(function(){
        ...
        console.log($each_total_price); //옵션가 포함한 가격을 배열데이터로 저장(변동)
